...
//路由自动化
func (c *AdminMenu) URLMapping() {
	c.Mapping("List", c.List)
}

//检测名称重复
// @router /admin/check_title [post]
func (c *AdminMenu) CheckTitle() {
	//ID 获取 格式化
	id, _ := c.GetInt("id")
	name := c.GetString("wd")
	//初始化
